...
export const Prism: React.FC<PrismProps> = ({
  ...
  useEffect(() => {
    ...
    const prismContainer = container as HTMLDivElement & { __prismIO?: IntersectionObserver };
  ...
  return <div className={`prism-container ${className}`} ref={containerRef} style={style} />;
};
